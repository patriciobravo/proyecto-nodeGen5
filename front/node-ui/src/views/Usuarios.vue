<template>
   <div class="container-fluid">
    ...
    <div v-if="itemUsuarios.length > 0">
      <div
        class="tables_info"
      ...
      >
        ...
        <span v-if="itemUsuarios.length > this.totalRows">
          (filtrado de un total de {{ itemUsuarios.length }} registros)
        </span>
      </div>
      <div
...
export default {
  ...
  methods:{
    ...
    ...mapActions(["ListProductos", "ListUsuarios"]),
    ...
    paginador: function (items) {
      ...
      if (this.totalRows === 0) {
        ...
        this.itemUsuarios.length > this.totalRows &&
        this.totalRows === 0
      ) {
        this.registroInicial = 0;
      } else {
